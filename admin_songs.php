...
<img class="imgl" src="Ms records logo.PNG" width="130" height="130" alt="">
	    	...
	    	<nav>
				...
				<li><a href="music1.php"><b><u>Home</u></b></a></li>
        			<li><a href="admin_recordingstudio"><b><u>RECORDING STUDIOS</u></b></a></li>
...
<th style='width:30%;background-color:black; padding-left:25px;'>
<table>
<thead>
<tr>
...
<th style='width:25%;background-color:black; color:white;'>
<audio controls>
  <source src='$row[allbum_audio]' type='audio/mpeg'>
</audio><br>
<a href='http://$row[allbum_youtube]' >$row[allbum_youtube]</a>
</th>
<th style='background-color:black;font-style:oblique;width:3%'>
<a href='admin_songsphp.php?u_id=$row[u_id]' class='btn btn-info' name='delete'>Delete</button></th>
</tr>";
$c++;
	   }
 ?>
